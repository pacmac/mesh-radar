...
source_hash: 5f4357c074140d58b8aabe51ef529521fa83101b46c8d423f2eb3e897ffbe5bc
updated: 2026-07-20
---
...
```js
controlDevices()        // → [{num,label}] — favourites first, then messageable nodes
...
- **Device picker** — `controlDevices()` merges `favourites` (server nav list) ahead
  of `allMsgNodes()`, deduped. One-click sets `controlTarget`.
