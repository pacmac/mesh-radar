...
source_hash: 6826fdeeeec0ff80290c6e7a7a0fc5dacd905650546ce5b7fc2ab86b9049cf38
updated: 2026-07-16
---
...
Config page HTML template: five sub-tabs (Bridge, Rotator, Modes, Radar,
Alerts). Per-radio section/channel/owner forms live on Devices. Presentation
only.

## Mobile containment (2026-07-23)

The five tabs use a full-width five-column grid below `sm`, compact type and
padding, then return to their intrinsic desktop tab width. All labels remain
visible at 390px.
